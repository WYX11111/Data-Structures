...
int main()
{
  ...
  while (true)
  {
    ...
    cin>>option;
      ...
      if (domainTree.initalFlag)
      {
	      cout<<"请输入网址，例如: www.tsinghua.edu.cn"<<endl;
      ...
      if (domainTree.initalFlag)
      {
	      cout<<"请输入网址和IP,例如: www.tsinghua.edu.cn/166.111.9.2"<<endl;
		    cin>>websiteWithIP;
      ...
      if (domainTree.initalFlag)
      {
	      cout<<"请输入一个IP，例如: 166.111.9.2"<<endl;
		    cin>>newIP;
	      cout<<"请输入一个网址，例如: www.tsinghua.edu.cn"<<endl;
	      cin>>websiteWithoutIP;
